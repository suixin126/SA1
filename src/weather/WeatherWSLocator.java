 ...
 */
    ...
    public weather.WeatherWSSoap_PortType getWeatherWSSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public weather.WeatherWSSoap_PortType getWeatherWSSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            weather.WeatherWSSoap12Stub _stub = new weather.WeatherWSSoap12Stub(portAddress, this);
    ...
    public weather.WeatherWSSoap_PortType getWeatherWSSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public weather.WeatherWSSoap_PortType getWeatherWSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            weather.WeatherWSSoap_BindingStub _stub = new weather.WeatherWSSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (weather.WeatherWSSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                weather.WeatherWSSoap12Stub _stub = new weather.WeatherWSSoap12Stub(new java.net.URL(WeatherWSSoap12_address), this);
                _stub.setPortName(getWeatherWSSoap12WSDDServiceName());
                return _stub;
            }
            if (weather.WeatherWSSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                weather.WeatherWSSoap_BindingStub _stub = new weather.WeatherWSSoap_BindingStub(new java.net.URL(WeatherWSSoap_address), this);
                _stub.setPortName(getWeatherWSSoapWSDDServiceName());
                return _stub;
            }
        }
