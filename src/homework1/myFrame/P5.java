...
public class P5 extends JPanel{
    public P5(String filePath, Ways ways){
        ...
        jLabel2_1.setBounds(0,50,300,100);
        add(jLabel2);
        add(jLabel2_1);

        ways.processWay(filePath);
        jLabel2_2.setBounds(0,170,300,40);
        jLabel2_3.setBounds(0,220,300,100);
        add(jLabel2_2);
        add(jLabel2_3);
        // 代码信息
        ...
        JLabel jLabel2_9 = new JLabel(new ImageIcon("C:\\houduanstudy\\java\\SA\\untitled\\resource\\P5.png"));
        ...
        JLabel jLabel2_11 = new JLabel(new ImageIcon("C:\\houduanstudy\\java\\SA\\untitled\\resource\\P1.png"));
